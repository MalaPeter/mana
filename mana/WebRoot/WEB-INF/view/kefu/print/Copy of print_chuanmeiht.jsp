...
function doPrint(how) {
	//var m = parseInt(document.getElementById('marginSelect').value);
	myDoc = {
         		documents: document,
...
<body>
	...
	<div id='page1' style="position:absolute;width:794px;height:1123px;margin-left:auto;margin-right:auto;border:solid 3px #ccc;z-index:99;">
		<table border="0" width="694" height="110" style="margin-left: 50px;margin-top: 50px">
			<tr align="center">
			...
			<tr height="20" align="right" style="font-size: 12px">
				<td>合同编号：${model.bianhao}</td>
			</tr>
		</table>
		<table border="0" width="694" height="870" style="margin-left: 50px;font-size: 12px;border-collapse:collapse;">
			<tr>
			...
			<tr>
				<td class="td1" height="110" colspan="2" valign="top">播出时段： ${model.shiduan} <br>不播出日期：${model.nodate}</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="td1" height="170" colspan="2">
				合同条款：<br>
			...
			<tr>
				<td height="173" colspan="2" class="td1">
			...
			<tr>
				<td height="20" colspan="2">名称：吉林广电传媒有限责任公司 开户行：中国工商银行长春人民广场支行
