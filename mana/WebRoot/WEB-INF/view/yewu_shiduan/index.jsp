...
<html>
  <head>
	...
	function savetr(trflag) {
		if(!subform()) {
			...
			$.ajax( {   
			    type : "POST",
			    url : "<%=request.getContextPath()%>/yewu_shiduan/saveshiduan",
			    data : {
  ...
  <body>
   	<div id="p" class="easyui-panel" title="合同录入-广电传媒合同录入单" style="width:800px;height:800px;padding:1px;text-align: center;" fit="true">
		<h1>广告发布合同 - 代理(DL)</h1>
		<h2><input id="daili" style="width: 400"></h2>
		...
		<table class="my-table" id="maintable">
			<tr>
				...
				<td colspan="3">合同日期：<input id="cdate" name="cdate" class="easyui-datebox"></input></td>
			</tr>
			<tr>
				<td>发布媒体：</td>
				<td colspan="8">
			...
			<tr align="center">
				...
				<td rowspan="2" width="7%">刊例价</td>
				<td rowspan="2" width="5%">折扣</td>
				<td rowspan="2" width="7%">净价</td>
				<td rowspan="2" width="5%">天数</td>
				<td rowspan="2" width="7%">净价总计</td>
				<td width="50%">
